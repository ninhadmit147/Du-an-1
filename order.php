...
<body>
    ...
    <!-- body -->
    <div class="container mx-auto my-8 text-right">
        ...
        <h2 class="text-center mt-24 mb-12 text-3xl">GIỎ HÀNG</h2>
        <form action="" method="post">
            <table class="table w-full text-center">
                ...
                <tbody>
                    <tr class="divide-y">
                        ...
                        <td>7,000,000 ₫</td>
                        <td><input type="number" name="amount" value="1" class="border w-12" min="1" id=""></td>
                        <td>7,000,000 ₫</td>
                        <td><a href="dell_order.php">Xóa</a></td>
                    </tr>
                    <tr class="divide-y">
                        <td class="flex mx-36 my-5">
                            <img src="./images/tuonggo537-1.jpg" class="w-24 h-24" alt="">
            ...
            <button type="submit" class="bg-blue-500 w-36 h-12 text-gray-100 font-bold my-8">THANH TOÁN</button>
        </form>
    </div>
    <!-- footer -->
